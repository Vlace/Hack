...
//corrects the class and text of the stories list so that they are correct when refreshing, etc.
...
function showFavesList() {
	...
	if (currentUser.favorites[0]=== undefined){
			$allStoriesList.append($('<i>If you would like to add a story to your favorites you can click the (-) in the story row.</i>'))
		}
	// loop through all of our stories and generate HTML for them
